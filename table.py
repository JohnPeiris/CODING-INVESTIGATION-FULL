...
def CreateTable(ISO, shutterspeed, aperture):
    class Cell(Frame):
    ...
    table = Table(root, ["ISO", "Shutterspeed", "Aperture"], column_minwidths=[None, None, None])
    table.pack(expand=True, fill=X, padx=10,pady=10)

    table.set_data([[ISO, shutterspeed, aperture]])
    root.mainloop()